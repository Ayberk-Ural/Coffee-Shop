...
video_file = open('video miuul logo.mp4', 'rb')
...
col1, col2, col3 = st.columns(3)
col2.markdown("<h5 style='text-align: center;'> </h5>", unsafe_allow_html=True)
...
#########################################
# Vahit Keskin Fotoğraf
#########################################

col1, col2, col3 = st.columns(3)
col2.markdown("<h5 style='text-align: center;'> </h5>", unsafe_allow_html=True)
col2.image("karavan vahit.jpg", width=600, use_container_width=False) #tüm ekran için true yap
col2.markdown("<h3 style='text-align: center;'> </h3>", unsafe_allow_html=True)

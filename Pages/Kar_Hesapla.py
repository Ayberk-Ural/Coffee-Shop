...
col2.image("LOGO.png", width=550, use_container_width=False)
...
st.markdown("<h3 style='text-align: center; color: green;'>Günlük Sabit Lokasyonunuzu Seçiniz:</h3>", unsafe_allow_html=True)
st.markdown("<h5 style='text-align: center;'> </h5>", unsafe_allow_html=True)
...
if col2.button("Lokasyon 1 : Mavişehir"):
    ...
    st.session_state.marketing_spend = 2250
...
if col3.button("Lokasyon 2 : Bostanlı"):
    ...
    st.session_state.marketing_spend = 2100
...
if col4.button("Lokasyon 3 : Karşıyaka"):
    ...
    st.session_state.marketing_spend = 1700

col1, col2, col3 = st.columns(3)
col2.markdown("---")
col2.markdown("<h3 style='text-align: center; color: red;'>Yaklaşan Etkinlikler</h3>", unsafe_allow_html=True)


col1, col2, col3, col4, col5 = st.columns(5)
if col2.button("Sabahat Akkiraz - Suat Taşer Tiyatrosu"):
    col2.markdown("<h6 style='text-align: left;'>Konum Yaya Trafiği: 1500</h6>", unsafe_allow_html=True)
    col2.markdown("<h6 style='text-align: left;'>Ortalama Günlük Müşteri Sayısı: 300</h6>", unsafe_allow_html=True)
    col2.markdown("<h6 style='text-align: left;'>Ortalama Sipariş Tutarı: 210</h6>", unsafe_allow_html=True)
    st.session_state.foot_traffic = 1000
    st.session_state.num_customers = 500
    st.session_state.avg_order_value = 250
    st.session_state.marketing_spend = 2500

if col3.button("Bir Tutam Çehov - Han Tiyatrosu"):
    col3.markdown("<h6 style='text-align: left;'>Konum Yaya Trafiği: 2500</h6>", unsafe_allow_html=True)
    col3.markdown("<h6 style='text-align: left;'>Ortalama Günlük Müşteri Sayısı: 400</h6>", unsafe_allow_html=True)
    col3.markdown("<h6 style='text-align: left;'>Ortalama Sipariş Tutarı: 250</h6>", unsafe_allow_html=True)
    st.session_state.foot_traffic = 600
    st.session_state.num_customers = 275
    st.session_state.avg_order_value = 225
    st.session_state.marketing_spend = 1750

if col4.button("Salih Tıraş Stand-Up - Rene Lokal"):
    col4.markdown("<h6 style='text-align: left;'>Konum Yaya Trafiği: 3500</h6>", unsafe_allow_html=True)
    col4.markdown("<h6 style='text-align: left;'>Ortalama Günlük Müşteri Sayısı: 450</h6>", unsafe_allow_html=True)
    col4.markdown("<h6 style='text-align: left;'>Ortalama Sipariş Tutarı: 150</h6>", unsafe_allow_html=True)
    st.session_state.foot_traffic = 800
    st.session_state.num_customers = 275
    st.session_state.avg_order_value = 175
    st.session_state.marketing_spend = 1700
...
st.session_state.num_customers = col2.number_input("Günlük Müşteri Sayısı", min_value=0, value=st.session_state.num_customers, disabled=True)
st.session_state.avg_order_value = col2.number_input("Ortalama Sipariş Tutarı (₺)", min_value=0, value=st.session_state.avg_order_value, disabled=True)
st.session_state.marketing_spend = col2.number_input("Günlük Pazarlama Harcaması (₺)", min_value=0, value=st.session_state.marketing_spend, disabled=True)
